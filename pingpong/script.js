function Game(canvasId) {
    ...
    function Ball(boundWidth, boundHeight) {
        ...
        this.update = function() {
            ...
            if(nextY < this.rad || nextY > boundWidth - this.rad) {
                this.dy *= -1 
            }
    ...
    this.state = function(stageName) {
        ...
        if (stageName == "PLAY_SOLO" || "PLAY_DUO") {
            this.balls = [];
    ...
    this.fireKeyUp = function (event) {
        this.game.keypress_table[event.code.toString()] = false
    }
    ...
    this.update = function() {
        if (this.stage == "PLAY_SOLO"){
            ...
            if(this.stage == "PLAY_SOLO" && this.racket1) {
                ...
                var isDiffrentPosition = this.balls && this.racket.y != this.balls[0];
                ...
                if(tickSometime) {
                    if(this.racket1.y <= this.racket.height / 2 + 10) this.racket1.accelate(+40);
